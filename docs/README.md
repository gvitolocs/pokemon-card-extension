...
Primary project overview is in the root `README.md`.

Use this folder for technical and maintenance docs:
...
If you add new docs, keep them:

- In English
- Aligned with the current repository structure
- Focused on one topic per file
